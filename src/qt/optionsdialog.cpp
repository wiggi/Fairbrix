        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start Fairbrix on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start Fairbrix after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the Fairbrix client port on the router. This only works when your router supports UPnP and it is enabled."));
