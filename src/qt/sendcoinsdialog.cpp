...
void SendCoinsDialog::on_sendButton_clicked()
{
    ...
    {
        QMessageBox::warning(this, tr("Send FBX"),
    ...
    QMessageBox::StandardButton retval = QMessageBox::question(this, tr("Confirm send FBX"),
                          tr("Are you sure you want to send %1 FBX to %2 (%3)?").arg(GUIUtil::formatMoney(payAmountParsed), label, ui->payTo->text()),
